...
const Contents = () => {
	return (
		<div className="md:columns-2 gap-8 md:gap-12">
			<p className="leading-7 opacity-70 mb-2">Service Desk Management: In today's fast-paced digital landscape, harnessing the power of cutting-edge IT service software is crucial for staying ahead of the competition. Our comprehensive suite of IT service solutions is tailored to meet the diverse needs of businesses, empowering you to streamline operations, enhance productivity, and deliver exceptional customer experiences.
			</p>
			...
			<div className="container px-4 sm:px-20">
				<div className="grid grid-cols-12">
					<div className="col-span-12 lg:col-span-6">
						...
						We provide enterprise-focused, certified cloud and cyber security solutions to big businesses.
						</p>
					</div>
