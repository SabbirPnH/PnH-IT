        ...
        <div className="tab-pane fade-in active">
            <div className="row flex-wrap grid lg:grid-cols-3 bg-zinc-900 text-white p-4 sm:p-7 -mx-2">
                <div className="col-lg-8 order-2 col-span-2 lg:order-1 px-2" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <ul className="list-none p-0">
                        <li className="flex items-center pb-2">
                            <IoShieldCheckmark className="bi bi-check-circle-fill text-[#F68921] text-7xl  sm:text-4xl mr-4"></IoShieldCheckmark> Domain Registration: This service allows you to secure a unique domain name (e.g., www.example.com) for your website. A domain name is your website's address on the internet.
                        </li>
                        <li className="flex items-center pb-2">
                            <IoShieldCheckmark className="bi bi-check-circle-fill text-[#F68921] text-7xl  sm:text-4xl mr-4"></IoShieldCheckmark> Web Hosting: Hosting services provide the infrastructure needed to store your website's files and make them accessible on the internet. Different types of hosting (shared, VPS, dedicated, cloud) offer varying levels of performance and control.
                        </li>
                    </ul>
                </div>
                <div className="col-lg-4 col-span-1 order-1 lg:order-2 text-center px-2" data-aos="fade-up" data-aos-delay="200">
