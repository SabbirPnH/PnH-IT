...
const Shapes = () => (
	<>
		<svg
			className="absolute top-0 right-0 hidden md:block text-slate-200 dark:text-slate-800 dark:text-opacity-50 -z-10"
			width="492"
			height="619"
			viewBox="0 0 492 619"
			fill="currentColor"
		...
		<svg
			className="absolute top-[35%] left-[5%] -z-10"
			width="49"
			height="40"
			viewBox="0 0 49 40"
			fill="none"
...
const ServiceHeader = () => {
	return (
		<section className="ezy__header32 light py-10 bg-white dark:bg-[#0b1727] text-zinc-900 dark:text-white relative overflow-hidden z-10">
			<Shapes />

			<div className="container px-4 mx-auto">
				<div className="grid grid-cols-12 gap-y-6 md:gap-x-6 text-center md:text-start">
					<div className="col-span-12 md:col-span-5 flex flex-col justify-center">
						<h1 className="text-3xl md:text-6xl leading-none font-bold mb-2">
						Technological Solutions
						</h1>
						<p className="text-xl leading-normal opacity-80 mb-12">
						Create reliable web applications to meet your company&aposs needs and devotedly serve your customers.
						</p>
						<div>
					...
					<div className="col-span-12 md:col-span-5 md:col-start-8">
						<div className="relative">
							<img
								...
								alt=""
								className="w-96 h-auto shadow-xl rounded-full"
							/>
