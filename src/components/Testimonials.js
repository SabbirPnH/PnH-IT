...
// 	};
// 	return (
// 		<section  className="ezy__testimonial12 light relative  dark:bg-[#0b1727] text-zinc-900 dark:text-white z-[1]">
...
// 								<div className="absolute -top-[10%] md:top-0 right-0 left-0 md:-left-[20%] bottom-0 bg-blue-[#1d294f] bg-[#1d294f] dark:bg-slate-800 -z-[1] rounded-b-xl sm:rounded-xl"></div>
// 								<div className="flex flex-col text-white justify-center h-full  mb-3">
...
// 										<p data-aos="fade-up"
//      data-aos-duration="2000" className="opacity-50 line-clamp-2 sm:line-clamp-2">{description}</p>
// 									</div>
...
// import classNames from "classnames";
// import PropTypes from "prop-types";
// import getTestimunial from "../../lib/Testimunial";
...
//             const data = await getTestimunial();
...
//                                 <div
//                                     className="bg-center bg-no-repeat bg-cover rounded-t-xl sm:rounded-xl h-full min-h-[250px] sm:min-h-[450px] md:w-full object-cover"
//                                     style={{ backgroundImage: `url(${image})` }}
//                                 ></div>
//                             </div>
//                             <div className="md:w-[700px] relative w-[300px]">
//                                 <div className="absolute -top-[10%] md:top-0 right-0 left-0 md:-left-[20%] bottom-0 bg-blue-[#1d294f] bg-[#1d294f] dark:bg-slate-800 -z-[1] rounded-b-xl sm:rounded-xl"></div>
//                                 <div className="flex flex-col text-white justify-center h-full  mb-3">
//                                     <div className="p-6 lg:py-16">
//                                         <h4 className="text-2xl font-bold mb-4">{name}</h4>
//                                         <p className="w-full">{designation}</p>
//                                         <Rating rating={star} showLabel={false} />
//                                         <p data-aos="fade-up" data-aos-duration="2000" className="opacity-50 line-clamp-2 sm:line-clamp-2">{review}</p>
//                                     </div>
//                                     <div className="px-6 lg:px-12 text-end">
//                                         <button
//                                             className="w-10 h-10 text-[12px] border border-[#1d294f] dark:border-slate-600 rounded-full inline-flex items-center justify-center duration-150 bg-[#F68921] hover:bg-[#e07a19] hover:text-slate-800 dark:hover:bg-slate-700 dark:hover:text-slate-200 mr-3"
