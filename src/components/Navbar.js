...
//     <main>
//       <div>
//         <header ref={navbarRef} className="flex justify-between items-center border-b py-4 px-4 sm:px-16 bg-white font-sans min-h-[70px] tracking-wide relative z-50">
//           {/* Logo on the left */}
//           <Link href={'/'}>
//             <Image src={logo} alt="logo" className="w-36" />
//           </Link>
...
//                         <p className={`${index === menu.length - 1 ? 'px-4 py-2.5 text-sm rounded font-bold text-white border-2 border-[#1d294f] bg-[#1d294f] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#1d294f]' : 'hover:text-[#1d294f] text-gray-600 block font-bold text-[15px] from-after'}`}>
//                           {menuItem.menu_name}
//                         </p>
//                       </Link>
//                       {menuItem.sub_menu && (
              ...
              <div className="lg:!flex lg:flex-auto max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50">
                <ul className="lg:flex items-center lg:gap-x-8 max-lg:space-y-2 ">
                  {menu.map((menuItem, index) => (
                    <li
                      key={menuItem.id}
                      className={`max-lg:border-b max-lg:py-3  ${index === menu.length - 1 ? 'border-l border-[#333] pl-2 h-9 -mt-2 max-lg:hidden' : ''} ${menuItem.sub_menu ? 'group relative' : ''}`}
                    >
                      <Link href={menuItem.url}>
                        <p className={`${index === menu.length - 1 ? 'px-4 py-2 text-sm rounded font-bold text-white border-2 border-[#1d294f] bg-[#1d294f] transition-all ease-in-out duration-300 hover:bg-transparent hover:text-[#1d294f]' : 'hover:text-[#1d294f] text-gray-600 block font-bold text-[15px] from-after'}`}>
                          {menuItem.menu_name}
                        </p>
                      </Link>
                      {menuItem.sub_menu && (
