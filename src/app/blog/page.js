...
// Define your fetch function outside the component
...
const BlogItem = ({ blog }) => {
  const {id, desp, short_desp, post_info, date, author_link, author, title, image } = blog;
    ...
    <article className="shadow-lg bg-white dark:shadow-none dark:bg-[#1E2735] rounded overflow-hidden h-full">
      ...
      <div className="p-3 pb-8 md:p-6 md:pb-5">
        ...
        <p>
          <span className="ml-2">
            By
            <a href={author_link} className="text-[#F68921] opacity-70">
              {author}
            </a>
          </span>
          <span>
        ...
        <p className="opacity-60 mt-3 mb-8">{short_desp}</p>
        <div className="flex items-center cursor-pointer">
          <Link href={`/blog/${id}`} className="bg-transparent hover:text-[#F68921] pt-2.5 px-5 transition">
            Read More
          </Link>
